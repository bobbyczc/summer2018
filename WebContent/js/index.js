var initTime=function(temp) {
  ...
  DateRangePicker = (function() {
    function DateRangePicker($select) {
      ...
      this.$select.attr('tabindex', '-1').after(this.$dateRangePicker);
      this.isHidden = true;
    ...
    DateRangePicker.prototype.initBindings = function() {
      ...
      return this.$dateRangePicker.find('.drp-timeline-presets li').click(function(evt) {
        ...
        $(self.$select[0]).find("option").attr("selected",false);
        $(self.$select[0]).find("option").eq(presetIndex).attr("selected",true);
    ...
    DateRangePicker.prototype.showCustomDate = function() {
      ...
      this.$select.find('option:last-child').attr("selected",true);
      this.$select.find('option:last-child').text(text);
      this.$select[0].selectedIndex = this.customOptionIndex;
    ...
    DateRangePicker.prototype.formatDate = function(d) {
    	...
    	return "" + (d.getFullYear().toString())+ timeConnector1 + (d.getMonth() + 1) + timeConnector2 + (d.getDate()) ;
    };
